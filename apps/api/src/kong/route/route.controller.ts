...
export class RouteController extends CommonController {
  /**
   * 构造函数
  ...
  async list(
    ...
    res.locals.result = await this.objectService.list(instanceId, 'routes');
  }
  ...
  async get(
    ...
    res.locals.result = await this.objectService.get(instanceId, 'routes', id);
  }
